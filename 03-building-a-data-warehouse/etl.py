...
#Drop table กรณีที่มีการอัปเดต Table เดิม ในการรันครั้งต่อไป
drop_table_queries = [
...
#สร้างตัวแปรเพื่อเก็บคำสั่ง sql ในการสร้างตาราง
...
copy_table_queries = [
    """
    COPY staging_events FROM 's3://lilly-my-json/events_json_path.json'
...
def main():
    host = "redshift-cluster-1.cxmo4um5uuoa.us-east-1.redshift.amazonaws.com:5439"
    dbname = "dev"
    user = "awsuser"
    password = "Lilly180922"
    port = "5439"
